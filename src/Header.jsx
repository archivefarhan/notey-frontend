      ...
      <header aria-label="Site Header" class="shadow-sm">
        <div class="mx-auto flex h-16 max-w-screen-xl items-center justify-between px-4">
          ...
          <div class="flex items-center gap-4">
            ...
            <form class="mb-0 hidden lg:flex">
              <div class="relative">
                ...
                <button type="submit" class="absolute inset-y-0 right-0 rounded-r-lg p-2 text-gray-600">
          ...
          >
            ...
            <a class="text-gray-900" href="/notes">
              Notes
            </a>
          </nav>

          <div class="hidden items-center gap-4 lg:flex">
            <a href="/login" class="rounded-lg bg-gray-100 px-5 py-2 text-sm font-medium text-gray-600">
              Log in
            </a>

            <a href="/signup" class="rounded-lg bg-blue-600 px-5 py-2 text-sm font-medium text-white">
              Sign up
            </a>
          </div>
        </div>
        ...
        <div class="border-t border-gray-100 lg:hidden">
          <nav class="flex items-center justify-center overflow-x-auto p-4 text-sm font-medium">
            ...
            <a class="flex-shrink-0 pl-4 text-gray-900" href="/notes">
              Notes
            </a>
          </nav>
        </div>
