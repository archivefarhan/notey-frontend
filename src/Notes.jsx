                ...
                {openText ? (
                  ...
                  <>
                    <div className="flex justify-center">
                      <button
                        className="mx-auto text-center m-2 text-blue-600 font-bold border border-blue-600 rounded-xl w-1/2"
                    ...
                    <div className="flex justify-center">
                      <button className="mx-auto text-center m-2 text-orange-400 font-bold border border-orange-400 rounded-xl w-1/2">
                        Edit Notes
                      </button>
                    </div>
                    <div className="flex justify-center">
                      <button className="mx-auto text-center m-2 text-red-600 font-bold border border-red-600 rounded-xl w-1/2">
                        Delete Notes
                      </button>
                    </div>
                  </>
